              ...
              <form>
                ...
                <div className="mb-4">
                  ...
                  <textarea
                    ...
                    name="message"
                    rows="4"
                    className="mt-1 py-3 focus:ring-opacity-60 focus:ring-text-orange focus:outline-none focus:ring focus:border-[rgb(250,70,18)] block w-full shadow-sm sm:text-sm  px-2 rounded-md"
                ...
                <button
                  type="submit"
                  className="bg-text-orange hover:opacity-[80%] text-white py-2 px-4 rounded-full transition-colors duration-300 ease-in-out w-full"
                >
                  Send Message
                </button>
              </form>
